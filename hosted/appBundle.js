...
/* Sends post requests to the server using fetch. Will look for various
  ...
  */
var sendPost = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(url, data, handler) {
    var response, result;
  ...
  return function sendPost(_x, _x2, _x3) {
...
var PropTypes = __webpack_require__(556);
var handleDomo = function handleDomo(e, onDomoAdded) {
  e.preventDefault();
  helper.hideError();
  var name = e.target.querySelector("#domoName").value;
  var age = e.target.querySelector("#domoAge").value;
  var species = e.target.querySelector("#domoSpecies").value;
...
var DomoForm = function DomoForm(props) {
  ...
  return /*#__PURE__*/React.createElement("form", {
    ...
    onSubmit: function onSubmit(e) {
      return handleDomo(e, props.triggerReload);
    },
    className: "domoForm"
...
var DomoList = function DomoList(props) {
  ...
  var _useState = useState(props.domos),
  ...
  var domoNodes = domos.map(function (domo) {
    return /*#__PURE__*/React.createElement("div", {
      key: domo._id,
      className: "domo"
